...
export type GetCartByIdQuery = { __typename?: 'Query', cart?: { __typename?: 'Cart', id: string, totalItems?: number | null, items: Array<{ __typename?: 'CartItem', id: string, name?: string | null, quantity: number, lineTotal: { __typename?: 'Money', formatted: string }, unitTotal: { __typename?: 'Money', formatted: string, amount?: number | null } }>, subTotal: { __typename?: 'Money', formatted: string } } | null };
